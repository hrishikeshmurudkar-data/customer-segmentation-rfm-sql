--Create Database
CREATE DATABASE sales_rfm_analysis;

--Use Database
USE sales_rfm_analysis;
...
-- Q1) Which coutnry has the highest number of sales?
...
-- Q2) Which city has the highest number of sales in USA?
...
-- Q3) Which is the best product in United States of America (USA)?
...
-- Q4) Let's start by grouping sales by productline.
...
-- 6) November seems to be the best month, what product do they sell in November?
...
SELECT CUSTOMERNAME, MonetaryValue, Frequency, Recency,
       rfm_recency, rfm_frequency, rfm_monetary,
       rfm_cell, rfm_cell_string
FROM #rfm
...
-- Q9) What products are most often sold together?
